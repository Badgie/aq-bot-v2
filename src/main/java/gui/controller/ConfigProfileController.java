...
public class ConfigProfileController implements Initializable {
    ...
    private void loadProfile() throws IOException, AWTException {
        ...
        WEAP_ZERO_TYPE1.getSelectionModel().select(weapons.get(0).getAffinity().get(0).getAffinity());
        WEAP_ZERO_TYPE2.getSelectionModel().select(weapons.get(0).getAffinity().get(1).getAffinity());
        WEAP_ONE_NAME.setText(parseString(weapons.get(1).getName()));
        WEAP_ONE_TYPE1.getSelectionModel().select(weapons.get(1).getAffinity().get(0).getAffinity());
        WEAP_ONE_TYPE2.getSelectionModel().select(weapons.get(1).getAffinity().get(1).getAffinity());
        WEAP_TWO_NAME.setText(parseString(weapons.get(2).getName()));
        WEAP_TWO_TYPE1.getSelectionModel().select(weapons.get(2).getAffinity().get(0).getAffinity());
        WEAP_TWO_TYPE2.getSelectionModel().select(weapons.get(2).getAffinity().get(1).getAffinity());
        WEAP_THREE_NAME.setText(parseString(weapons.get(3).getName()));
        WEAP_THREE_TYPE1.getSelectionModel().select(weapons.get(3).getAffinity().get(0).getAffinity());
        WEAP_THREE_TYPE2.getSelectionModel().select(weapons.get(3).getAffinity().get(1).getAffinity());
        WEAP_FOUR_NAME.setText(parseString(weapons.get(4).getName()));
        WEAP_FOUR_TYPE1.getSelectionModel().select(weapons.get(4).getAffinity().get(0).getAffinity());
        WEAP_FOUR_TYPE2.getSelectionModel().select(weapons.get(4).getAffinity().get(1).getAffinity());
        WEAP_FIVE_NAME.setText(parseString(weapons.get(5).getName()));
        WEAP_FIVE_TYPE1.getSelectionModel().select(weapons.get(5).getAffinity().get(0).getAffinity());
        WEAP_FIVE_TYPE2.getSelectionModel().select(weapons.get(5).getAffinity().get(1).getAffinity());
        WEAP_SIX_NAME.setText(parseString(weapons.get(6).getName()));
        WEAP_SIX_TYPE1.getSelectionModel().select(weapons.get(6).getAffinity().get(0).getAffinity());
        WEAP_SIX_TYPE2.getSelectionModel().select(weapons.get(6).getAffinity().get(1).getAffinity());
        WEAP_SEVEN_NAME.setText(parseString(weapons.get(7).getName()));
        WEAP_SEVEN_TYPE1.getSelectionModel().select(weapons.get(7).getAffinity().get(0).getAffinity());
        WEAP_SEVEN_TYPE2.getSelectionModel().select(weapons.get(7).getAffinity().get(1).getAffinity());
